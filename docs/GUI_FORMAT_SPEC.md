...
| scale             | `[float; 2]` | Scale of an object.<br>Normalized to the parents scale by default,<br>in pixels if absolute_scale is true,<br>additive to parents scale if additive_scale is true                                                               |
...
| additive_scale    | `[bool; 2] ` | Refer to description of scale, each bool corresponds to the axis matching its index. Both default to false.                                                                                                                     |
...
| quads                    | `[integer]`               | Array of children quad indices             |
| texts                    | `[integer]`               | Array of children text indices             |
| position                 | Common                    | Common                                     |
| scale                    | Common                    | Common                                     |
